...
CameraController.prototype.initialize = function() {
    ...
    this.gridEntity.setPosition(0, this.entity.getPosition().y, 0);
};
...
CameraController.prototype.onRotate = function (rotateInput, dt) {
    this.entity.rotateLocal(0, rotateInput * dt * this.rotateSpeed, 0);
};
